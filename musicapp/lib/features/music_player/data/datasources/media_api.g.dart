...
class _MediaApi implements MediaApi {
  ...
  Future<ApiResponse<InitUploadResponse>> initUpload(
    ...
    final _options = _setStreamType<ApiResponse<InitUploadResponse>>(
    ...
    late ApiResponse<InitUploadResponse> _value;
    try {
      _value = ApiResponse<InitUploadResponse>.fromJson(
        _result.data!,
        (json) => InitUploadResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  @override
  Future<ApiResponse<void>> confirmUpload(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
