...
class _FavoritesApi implements FavoritesApi {
  ...
  @override
  Future<ApiResponse<List<SongDto>>> getMyFavorites() async {
  ...
  @override
  Future<ApiResponse<List<String>>> getFavoriteIds() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<bool>> toggleFavorite(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
