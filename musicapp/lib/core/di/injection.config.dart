...
import '../../features/favorites/data/datasources/favorites_api.dart' as _i552;
...
import '../../features/music_player/data/datasources/media_api.dart' as _i258;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i361.Dio>(
        () => registerModule.dio(gh<_i32.AuthInterceptor>()));
    gh.singleton<_i552.FavoritesApi>(
        () => registerModule.favoritesApi(gh<_i361.Dio>()));
    gh.singleton<_i367.AuthApi>(() => registerModule.authApi(gh<_i361.Dio>()));
    gh.singleton<_i478.SearchApi>(
        () => registerModule.searchApi(gh<_i361.Dio>()));
    gh.singleton<_i536.PlaylistApi>(
        () => registerModule.playlistApi(gh<_i361.Dio>()));
    gh.singleton<_i258.MediaApi>(
        () => registerModule.mediaApi(gh<_i361.Dio>()));
    gh.singleton<_i91.MusicApi>(() => registerModule.musicApi(gh<_i361.Dio>()));
    gh.lazySingleton<_i787.AuthRepository>(() => _i153.AuthRepositoryImpl(
          gh<_i367.AuthApi>(),
          gh<_i2.TokenStorage>(),
        ));
    gh.lazySingleton<_i212.FavoritesRepository>(
        () => _i144.FavoritesRepositoryImpl(gh<_i552.FavoritesApi>()));
